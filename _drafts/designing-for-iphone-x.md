...
אם נרצה לבטל את התנהגות זו ולהציג את התוכן על פני כל המסך, נוכל להשתמש בהרחבה חדשה לתגית המטא `viewport` הנקראת `viewport-fit`, המאפשרת לשלוט על איך תוכן האתר יוצג במקרים במקרים בהם גבולות המכשיר לא מרובעים.  
...
# לסיכום..
אחרי שהבנו את כל השינויים שצריך לבצע על מנת להתאים אתר לאייפון X, רציתי לציין שלדעתי המהלך הזה שאפל ביצעה שלילי, ואנחנו, מפתחי האתרים, לא צריכים לעודד או לתמוך בהתאמת אתרים למכשירים ספציפיים.
